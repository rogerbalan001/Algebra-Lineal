...
import numpy as np
import makarov as m  # Importamos tu módulo (asegúrate de que esté corregido)
import sys
...
class TextRedirector:
    """Redirige la salida de sys.stdout.write() a un widget Text de Tkinter."""
    ...
    def flush(self):
        # Requerido por la interfaz de file
        pass
...
class MarkovApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Paleta de Colores
        self.BG_COLOR = "#2E2E2E"       # Fondo principal oscuro
        self.FRAME_BG = "#3C3C3C"     # Fondo de frames más claro
        self.TEXT_COLOR = "#E0E0E0"     # Texto principal claro
        self.WHITE = "#FFFFFF"            # Texto blanco puro
        self.BTN_BLUE = "#007BFF"     # Color de acento para botones
        self.BTN_BLUE_ACTIVE = "#0056b3" # Botón presionado
        self.ENTRY_BG = "#5A5A5A"      # Fondo de cajas de texto
        self.CONSOLE_BG = "#1C1C1C"    # Fondo de consola
        self.CONSOLE_FG = "#00FF7F"    # Texto de consola (verde menta)

        style = ttk.Style(self)
        
        try:
            # 'clam' es el tema más personalizable
            style.theme_use('clam') 
        except tk.TclError:
            pass # Usar tema por defecto si 'clam' falla
        ...
        # Entradas de Texto (Entry y Combobox)
        style.map('TEntry',
        ...
        style.configure('TButton', 
            ...
            background='#5A5A5A', # Botón normal gris
            foreground=self.WHITE,
            padding=5
        )
        style.map('TButton',
        ...
        # Estilo de Botón de Acento (Azul)
...
class ConfigScreen(ttk.Frame):
    """Pantalla para definir los estados y la matriz N x N."""
    def __init__(self, parent, controller):
        ...
        content_frame.pack(expand=True) # <-- Centra el bloque
        ...
        # Botón de Navegación (con estilo de acento)
...
class ResultsScreen(ttk.Frame):
    """Pantalla para mostrar resultados (naranja) y gráficas (azul)."""
    def __init__(self, parent, controller):
        super().__init__(parent)
        self.controller = controller

        # Colores de la App (heredados del controlador)
        ...
        # Consola de Salida (Styling manual para widget 'tk', no 'ttk')
        ...
        # Frame donde se dibujará la gráfica
    ...
    def on_plot_evolution(self):
        """
        Dibuja la gráfica de evolución (VERSIÓN MODO OSCURO y ROBUSTA)
        """
        ...
        # --- Bloque Try/Except para la gráfica ---
        try:
            # --- Lógica de graficación (adaptada de tu plot_evolution) ---
            ...
            # --- ESTILO DE GRÁFICA MODO OSCURO ---
            
            # Mantenemos el tamaño más alto para dar espacio
            ...
            # ax1.set_xlabel('Tiempo', color=self.TEXT_COLOR) # Etiqueta "Tiempo" eliminada
            ...
            # --- ¡AQUÍ ESTÁ EL CAMBIO! ---
            # Acortamos el título para evitar la superposición
            ax2.set_title('Estacionario: Teórico vs Simulado', color=self.WHITE)
            # ---------------------------
            ...
            # Usamos tight_layout, que ahora funcionará
